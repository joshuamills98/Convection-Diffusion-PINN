...
class PINNModel:
    ...
    Outputs:
    - f_out: what we wish to minimize in order to regularize to the physics conditions (f_out = c_t +c_x-c_xx/Pe)
    ...
    def build(self):
        ...
        #c_ini: (for initial conditions we just evaluate base model at corresponding x, t and Pe values)
