...
class Network:
    ...
    @classmethod
    def basemodel(cls,num_inputs=3, hidden_layers=[20,20,20,20,20,20,20,20,20], activation_layers='tanh', num_outputs= 1):
...
def set_flattened_weights(model, flattened_weights):  # Useful method for setting the model weights provided with flattened weights
